...
const difficultyColor = {
  기본: 'bg-sage-100 dark:bg-sage-900/30 text-sage-700 dark:text-sage-300',
  맞춤: 'bg-azure-100 dark:bg-azure-900/30 text-azure-700 dark:text-azure-300',
  실용: 'bg-coral-100 dark:bg-coral-900/30 text-coral-700 dark:text-coral-300',
  트렌드: 'bg-plum-100 dark:bg-plum-900/30 text-plum-700 dark:text-plum-300',
  클린: 'bg-sage-100 dark:bg-sage-900/30 text-sage-700 dark:text-sage-300',
}
  ...
  return (
    <div className="card p-6 flex flex-col gap-4">
      ...
      <div className="flex items-center gap-2 flex-wrap">
        <span className={`subject-badge ${difficultyColor[book.difficulty] || 'bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300'}`}>
          {book.difficulty}
        </span>
        <span className="subject-badge bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300">
          {book.level}
        </span>
        <span className="ml-auto text-xs text-gray-400 dark:text-gray-500">{book.pages}p</span>
      </div>

      {/* 아이콘 + 제목 */}
      <div className="flex items-start gap-4">
        <div className="w-14 h-14 rounded-lg bg-gradient-to-b from-blush-200 to-azure-200 dark:from-blush-800/50 dark:to-azure-800/50 flex items-center justify-center flex-shrink-0 text-2xl shadow-sm">
          🛍️
        </div>
        <div>
...
/* ── AI 퍼스널 쇼퍼 배너 ── */
function AiShopperBanner({ subject }) {
  return (
    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-blush-500 to-azure-500 p-8 mb-10 text-white">
      ...
      <div className="relative z-10">
        ...
        <h2 className="text-2xl md:text-3xl font-extrabold mb-2">
          나에게 꼭 맞는 상품을 AI가 즉시 추천합니다
        </h2>
        <p className="text-white/80 mb-6 max-w-lg">
          취향, 체형, 예산을 선택하면 AI가 최적화된 상품을 자동으로 큐레이션합니다.
          가격 비교로 최저가도 놓치지 마세요.
        </p>
...
export default function Workbook() {
  ...
  const books = allWorkbooks[subject] || allWorkbooks.fashion
  ...
  return (
    <>
      ...
      <div className="page-hero">
        <div className="container-wrap">
          <div className="flex items-center gap-2 text-sm text-gray-400 mb-4">
            ...
            <span>›</span>
            <span className="text-gray-600 dark:text-gray-300">AI 추천</span>
            <span>›</span>
          ...
          <p className="text-gray-500 dark:text-gray-400">
            AI 퍼스널 쇼퍼가 큐레이션한 맞춤형 상품 가이드를 만나보세요.
          </p>
        </div>
      </div>
      ...
      <div className="container-wrap section-y">
        ...
        {/* ── AI 퍼스널 쇼퍼 배너 ── */}
        <AiShopperBanner subject={currentSubject} />

        {/* ── 추천 목록 ── */}
        <div className="flex items-center justify-between mb-6">
          <h2 className="font-bold text-gray-900 dark:text-white">
            {currentSubject.label} AI 추천 <span className="text-blush-500">({books.length}종)</span>
          </h2>
        </div>
        ...
        <div className="mt-12 text-center py-12 rounded-2xl border-2 border-dashed border-blush-200 dark:border-blush-800 bg-blush-50/50 dark:bg-blush-900/10">
          ...
          <h3 className="font-bold text-gray-900 dark:text-white mb-2">원하는 추천이 없나요?</h3>
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-6 max-w-sm mx-auto">
            취향·체형·예산을 직접 설정해 AI가 맞춤 상품을 바로 추천해 드립니다.
          </p>
